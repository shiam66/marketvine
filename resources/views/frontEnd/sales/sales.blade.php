                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                @for($i=1; $i<11;$i++)
                                    <tr>
                                        ...
                                        <td><input type="number" id="qty{{$i}}" name="qty{{$i}}" class="form-control form-control-sm"></td>
                                        <td><span id="unit{{$i}}"></span></td>
                                        <td><input type="number" id="unitPrice{{$i}}" name="unitPrice{{$i}}" class="form-control form-control-sm"></td>
                                        <td><input type="number" id="discount{{$i}}" name="discount{{$i}}" value="" class="form-control form-control-sm"></td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 offset-sm-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" id="others" name="others" class="form-control form-control-sm">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" id="advance" name="advance" class="form-control form-control-sm">
                                </div>
                            </div>
